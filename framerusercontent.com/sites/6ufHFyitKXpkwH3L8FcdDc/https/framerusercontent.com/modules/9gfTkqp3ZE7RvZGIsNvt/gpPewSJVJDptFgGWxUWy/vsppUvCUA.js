...
fontStore.loadFonts(["FR;InterDisplay-Bold", "FR;InterDisplay-Black", "FR;InterDisplay-BlackItalic", "FR;InterDisplay-BoldItalic"]);
export const fonts = [{
    explicitInter: true,
    fonts: [{
...
export const css = ['.framer-Te4i1 .framer-styles-preset-1eqthn:not(.rich-text-wrapper), .framer-Te4i1 .framer-styles-preset-1eqthn.rich-text-wrapper p { --framer-font-family: "Inter Display", "Inter Display Placeholder", sans-serif; --framer-font-family-bold: "Inter Display", sans-serif; --framer-font-family-bold-italic: "Inter Display", sans-serif; --framer-font-family-italic: "Inter Display", "Inter Display Placeholder", sans-serif; --framer-font-open-type-features: \'salt\' on; --framer-font-size: 11px; --framer-font-style: normal; --framer-font-style-bold: normal; --framer-font-style-bold-italic: italic; --framer-font-style-italic: italic; --framer-font-variation-axes: normal; --framer-font-weight: 700; --framer-font-weight-bold: 900; --framer-font-weight-bold-italic: 900; --framer-font-weight-italic: 700; --framer-letter-spacing: 0.1px; --framer-line-height: 13px; --framer-paragraph-spacing: 0px; --framer-text-alignment: center; --framer-text-color: var(--token-8413cbea-1c61-4230-8afb-d01ce642aca9, rgba(9, 9, 9, 0.6)); --framer-text-decoration: none; --framer-text-stroke-color: initial; --framer-text-stroke-width: initial; --framer-text-transform: none; }'];
export const className = "framer-Te4i1";
