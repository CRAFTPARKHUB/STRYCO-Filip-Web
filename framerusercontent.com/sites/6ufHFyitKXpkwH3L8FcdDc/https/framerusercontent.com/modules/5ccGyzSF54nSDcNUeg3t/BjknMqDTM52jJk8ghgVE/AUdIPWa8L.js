...
const variantClassNames = {
    fg2Qm7JpU: "framer-v-12waq4g",
    KTyV7Phkk: "framer-v-hgdv54"
};
...
const getProps = ({
    ...
    return { ...props,
        f8fgdu9JL: click ? ? props.f8fgdu9JL,
        Ln8d5mN1s: image ? ? props.Ln8d5mN1s ? ? {
            pixelHeight: 2560,
            pixelWidth: 2560,
            src: "https://framerusercontent.com/images/nvwMzGj6it9ES02wDvpqv67cBa0.jpg?scale-down-to=512&width=2560&height=2560",
        ...
        variant: humanReadableVariantMap[props.variant] ? ? props.variant ? ? "fg2Qm7JpU"
    };
};
...
const Component = /*#__PURE__*/ React.forwardRef(function(props, ref) {
    ...
    const onTapalztq6 = activeVariantCallback(async (...args) => {
        ...
        if (f8fgdu9JL) {
            const res = await f8fgdu9JL(...args);
        ...
        children: /*#__PURE__*/ _jsx(Variants, {
            ...
            children: /*#__PURE__*/ _jsx(Transition, {
                ...
                children: /*#__PURE__*/ _jsxs(motion.div, { ...restProps,
                    ...gestureHandlers,
                    className: cx(scopingClassNames, "framer-12waq4g", className, classNames),
                    "data-framer-name": "L",
                    "data-highlight": true,
                    ...
                    children: [ /*#__PURE__*/ _jsx(Image, {
                        background: {
                            alt: "",
                            fit: "fit",
                            loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + (0 + ((componentViewport ? .height || 180) - 0 - 175) / 2)),
                            pixelHeight: 2560,
                            pixelWidth: 2560,
                            sizes: "264px",
                            ...toResponsiveImage(Ln8d5mN1s),
                            ...{
                                positionX: "center",
                                positionY: "center"
                            }
                        },
                        className: "framer-1hrlcan",
                        layoutDependency: layoutDependency,
                        layoutId: "cPNYTsnmH"
                    }), isDisplayed() && /*#__PURE__*/ _jsx(motion.div, {
                        className: "framer-i8r105",
 ...
 */
const FramerAUdIPWa8L = withCSS(Component, css, "framer-hJ2mp");
export default FramerAUdIPWa8L;
FramerAUdIPWa8L.displayName = "Client Card XL";
FramerAUdIPWa8L.defaultProps = {
    height: 180,
    width: 268
};
addPropertyControls(FramerAUdIPWa8L, {
    variant: {
        options: ["fg2Qm7JpU", "KTyV7Phkk"],
        optionTitles: ["L", "S"],
        title: "Variant",
        type: ControlType.Enum
    },
    Ln8d5mN1s: {
        __defaultAssetReference: "data:framer/asset-reference,nvwMzGj6it9ES02wDvpqv67cBa0.jpg?originalFilename=LEGENDER-Tricko-biele-scaled.jpg&width=2560&height=2560",
        title: "Image",
...
//# sourceMappingURL=./AUdIPWa8L.map