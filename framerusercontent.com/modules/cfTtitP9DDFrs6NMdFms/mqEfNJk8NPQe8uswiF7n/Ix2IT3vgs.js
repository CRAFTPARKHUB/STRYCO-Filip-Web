...
fontStore.loadFonts(["FR;InterDisplay-SemiBold", "Inter-Bold", "Inter-BoldItalic", "Inter-Italic"]);
export const fonts = [{
    explicitInter: true,
    fonts: [{
