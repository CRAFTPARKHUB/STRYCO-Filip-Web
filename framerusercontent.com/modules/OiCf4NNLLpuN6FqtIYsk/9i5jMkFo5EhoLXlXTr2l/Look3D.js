...
import {
    SettingsMessage
} from "https://framer.com/m/Utils-QTIc.js@hDBsItohjMEOACix8wDv";
/**
 * @framerDisableUnlink
 *
...
export default function CursorRotation(props) {
    ...
    if (!children || children.length === 0) {
        return /*#__PURE__*/ _jsx(SettingsMessage, {
    ...
    const springConfig = withDragging ? transition : {
        duration: 0
    };
    ...
    useEffect(() => {
        const handleMove = event => {
            ...
            if (withDragging) {
                ...
                const rotationFactorX = (clientY / innerHeight - .5) * adjustedSensitivity;
                const rotationFactorY = (clientX / innerWidth - .5) * adjustedSensitivity;
    ...
    }, [isDragging, withDragging, withSnapBack, withRotationLimitX, withRotationLimitY, maxX, maxY, sensitivity]);
    useEffect(() => {
    ...
    const handleOnEnd = () => setIsDragging(false); // Clone the children and apply preserve-3d to them as well
    const clonedChildren = /*#__PURE__*/ cloneElement(children, {
    ...
    return /*#__PURE__*/ _jsx(motion.div, {
        ...
        style: { ...style,
            ...
            transformStyle: "preserve-3d",
            transformPerspective: withPerspective ? perspectiveValue : undefined,
            userSelect: "none",
            touchAction: "none"
        },
